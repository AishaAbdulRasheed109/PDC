...
Each folder corresponds to a specific task or project, including:
...
Matrix operations and parallel algorithms

Use of barriers, locks, and semaphores
...
Navigate to the folder of the task you want to explore.

Follow the instructions in the respective task folder to run the code.

Requirements

Python 3.x (if using Python)

Required libraries (check each task folder for requirements.txt)
